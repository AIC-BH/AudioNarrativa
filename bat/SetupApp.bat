...
:: Android packaging
set AND_CERT_NAME="AudioNarrativa"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AudioNarrativa.p12
...
set IOS_PROVISION=cert\AudioNarrativa.mobileprovision
